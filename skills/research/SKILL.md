...
1. Semantic Scholar (semanticscholar.org) — 200M+ papers, public API
2. arXiv (arxiv.org) — CS/math/physics/ML preprints, public API
3. Official documentation / authoritative technical sources (AWS docs, Anthropic docs, RFCs)
4. General web — last resort only, when 1–3 don't cover the topic
