# Graph Report - .agents  (2026-09-02)

## Corpus Check
- 408 files · ~523,715 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3370 nodes · 4952 edges · 335 communities (264 shown, 71 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 147 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29cd3246`
...
- `main()` --calls--> `dispatch()`  [INFERRED]
  skills/handoff/scripts/check_remote_session.py → lib/task_dispatch.py
- `main()` --calls--> `load_or_build()`  [INFERRED]
  skills/improve/scripts/check_and_trigger_merge.py → lib/machine_profile.py
- `main()` --calls--> `remote_devices()`  [INFERRED]
  skills/improve/scripts/check_and_trigger_merge.py → lib/machine_profile.py
...
### Community 0 - "paper_graph.py"
Cohesion: 0.15
Nodes (15): _confirm_checkpoint(), embed_paper(), fetch_neighbors_by_search(), _fetch_seed_abstract(), _get_with_retry(), _load_specter2(), main(), # NOTE: load_adapter() logs "There are adapters available but none are… (+7 more)

### Community 1 - "motion.12.42.2.js"
Cohesion: 0.04
Nodes (46): adopt(), be(), bl(), Bs(), collectTargets(), constructor(), Dr(), ec() (+38 more)
...
Cohesion: 0.10
Nodes (19): datetime, Exception, active_backoff(), parse_reset_time(), RateLimited, Returns the recorded backoff deadline if one exists and is still in the future,…, Raised by an executor when Claude Code's own headless output is a usage-limit…, Extract an absolute UTC datetime from a message like "You've hit your session… (+11 more)
...
### Community 14 - ".get"
Cohesion: 0.08
Nodes (30): Al(), As(), cl(), dl(), Es(), fl(), gl(), hl() (+22 more)
...
Cohesion: 0.08
Nodes (36): DISPATCH_STATE_PATH, readDispatchStatus(), execFileAsync, ghIssueView(), ADR-0024, ADR-0025, listOpenPrs(), postJson() (+28 more)
...
### Community 30 - ".getValue"
Cohesion: 0.13
Nodes (13): animateVisualElement(), Ao(), At(), bi(), ci(), In(), Je(), Li() (+5 more)
...
### Community 115 - "co"
Cohesion: 0.08
Nodes (8): ba(), co(), ei(), Eo(), hi(), update(), vr(), wr
...
### Community 123 - "test_paper_graph.py"
Cohesion: 0.12
Nodes (29): diminishing_returns(), fetch_neighbors_from_s2(), Semantic Scholar's paper endpoint accepts several ID namespaces (DOI:, ARXIV:,…, _s2_id(), select_candidates(), traverse(), Tests for paper-dive's paper_graph module. Run via: ~/.agents/venv/bin/python…, test_diminishing_returns_false_when_not_enough_history_yet() (+21 more)
...
### Community 249 - "test_gh_merge_guard.py"
Cohesion: 0.16
...
### Community 258 - "build_type_measure.py"
Cohesion: 0.14
Nodes (19): Path, One touched file -> the pytest path arg it implies. `skills/` gets two path…, Which test command matches what this ticket's diff actually touches, scoped…, _scope_root(), test_command_for(), _touched_files(), _touches_dashboard(), capture_dev_evidence() (+11 more)

### Community 259 - "build"
Cohesion: 0.29
Nodes (7): build, appId, directories, files, productName, output, out/**/*

### Community 260 - "mr_raiser.py"
Cohesion: 0.29
...
### Community 261 - "merge.js"
Cohesion: 0.08
Nodes (31): currentRemoteSha(), ADR-0026, makeGitFixture(), realExec, sh(), assertGithubPrUrl(), dropEntirely(), execFileAsync (+23 more)
...
Cohesion: 0.14
Nodes (8): _issue(), _no_rate_limit_backoff_by_default(), fixture, Tests for ticket_pipeline.py. Run via: ~/.agents/venv/bin/python -m pytest…, test_main_dry_run_does_not_claim_or_dispatch(), test_main_skips_dispatch_entirely_when_rate_limit_backoff_is_active(), test_unclaimed_ready_tickets_filters_out_claimed(), test_unclaimed_ready_tickets_sorted_oldest_first()

### Community 264 - "registry_id"
Cohesion: 0.43
...
### Community 265 - "background_architecture_review.py"
Cohesion: 0.30
...
### Community 272 - "$r"
Cohesion: 0.11
Nodes (14): bo(), br(), c(), fr(), Go(), Or(), pr(), $r() (+6 more)

### Community 273 - "run_ticket.py"
Cohesion: 0.14
Nodes (23): _comment_failure(), main(), A ticket that didn't raise a PR -- rate-limited, a worktree-creation failure,…, This machine has been free since execute_ticket returned above -- win or lose,…, _release_claim(), run(), _trigger_redispatch(), _create_worktree() (+15 more)
...
### Community 278 - "blended_score"
Cohesion: 0.22
Nodes (10): blended_score(), _cosine_similarity(), Blend SPECTER2 and nomic embeddings to hedge against citation-clique bias. See…, _shape_and_score(), test_blended_score_actually_blends_both_sources(), test_blended_score_is_one_for_identical_embeddings(), test_blended_score_rescues_cross_camp_rebuttal_specter2_alone_would_drop(), test_shape_and_score_preserves_arxiv_id_separate_from_doi() (+2 more)
...
### Community 281 - "research_digest.py"
Cohesion: 0.53
...
### Community 285 - "ticket_coordination.py"
Cohesion: 0.25
...
### Community 288 - "rebuild-manifest.py"
Cohesion: 0.35
...
### Community 290 - "improvement_sweep.py"
Cohesion: 0.29
...
### Community 300 - "ticket-29.md"
Cohesion: 0.02
Nodes (86): 2026-08-29T17:27:57.775329+00:00 — ticket-29, 2026-09-01T18:29:47.258247+00:00 — ticket-29, 2026-09-01T18:46:06.632981+00:00 — ticket-29, 2026-09-01T18:54:06.151684+00:00 — ticket-29, 2026-09-01T18:59:45.525256+00:00 — ticket-29, 2026-09-01T19:01:49.924661+00:00 — ticket-29, 2026-09-01T19:03:56.560115+00:00 — ticket-29, 2026-09-01T19:05:53.291606+00:00 — ticket-29 (+78 more)

### Community 301 - "ticket-30.md"
Cohesion: 0.22
Nodes (8): 2026-08-29T17:29:12.911104+00:00 — ticket-30, 2026-09-01T23:29:45.883116+00:00 — ticket-30, 2026-09-01T23:37:04.123556+00:00 — ticket-30, 2026-09-01T23:44:17.901955+00:00 — ticket-30, 2026-09-02T04:29:48.910170+00:00 — ticket-30, 2026-09-02T04:35:45.698180+00:00 — ticket-30, 2026-09-02T15:42:36.366701+00:00 — ticket-30, 2026-09-02T15:48:20.078570+00:00 — ticket-30

### Community 323 - "e"
Cohesion: 0.07
Nodes (23): ar(), ca(), cr, e(), er(), finalize(), Gr(), ha() (+15 more)

### Community 326 - "mn"
Cohesion: 0.07
Nodes (6): Ae(), mn(), sn(), vn(), xn, yn
...
### Community 330 - "source_monitor.py"
Cohesion: 0.26
Nodes (8): correlate(), roadmap_match(), fetch_arxiv(), fetch_github(), fetch_hackernews(), main(), save_raw_cache(), store_items()

### Community 331 - "0032 — mac-mini as primary automation host for ticket-pipeline"
Cohesion: 0.33
...
## Knowledge Gaps
- **892 isolated node(s):** `2026-08-29T17:29:12.911104+00:00 — ticket-30`, `2026-09-01T23:29:45.883116+00:00 — ticket-30`, `2026-09-01T23:37:04.123556+00:00 — ticket-30`, `2026-09-01T23:44:17.901955+00:00 — ticket-30`, `2026-09-02T04:29:48.910170+00:00 — ticket-30` (+887 more)
...
- **Why does `log_hook_error()` connect `log_hook_error` to `rebuild-manifest.py`, `session_start_report.py`, `improvement_sweep.py`, `verify.py`, `background_architecture_review.py`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `machine_label()` connect `code_sync.py` to `ticket_claim.py`, `registry_id`, `source_monitor.py`, `machine_profile.py`, `QA-Agent Capture`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
...
- **What connects `2026-08-29T17:29:12.911104+00:00 — ticket-30`, `2026-09-01T23:29:45.883116+00:00 — ticket-30`, `2026-09-01T23:37:04.123556+00:00 — ticket-30` to the rest of the system?**
