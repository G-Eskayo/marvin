...
- **Why does `machine_label()` connect `code_sync.py` to `ticket_claim.py`, `machine_profile.py`, `source_monitor.py`, `registry_id`, `QA-Agent Capture`, `sandbox_orchestration.py`?**
